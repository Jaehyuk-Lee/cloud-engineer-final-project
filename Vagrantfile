...
Vagrant.configure(Vagrant_API_Version) do |config|
  ...
  config.vm.define:"ansible-server" do |cfg|
    ...
    cfg.vm.provision "shell", path: "C:/Users/Swordbill/Downloads/f_project/cloud-engineer-final-project/scripts/bootstrap.sh"
    cfg.vm.provision "file", source: "C:/Users/Swordbill/Downloads/f_project/cloud-engineer-final-project/ansible/env/ready_ansible_env.yaml", destination: "ready_ansible_env.yaml"
