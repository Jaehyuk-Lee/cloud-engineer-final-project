...
CREATE TABLE IF NOT EXISTS User (
    UserID INT PRIMARY KEY, Name VARCHAR(50), ResidentRegistrationNumber VARCHAR(13), ContactNumber VARCHAR(14), Address VARCHAR(100), Email VARCHAR(50)
);
...
INSERT INTO
    User (
        UserID, Name, ResidentRegistrationNumber, ContactNumber, Address, Email
    )
VALUES (
